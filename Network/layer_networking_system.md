...
클라이언트는 라우터의 _Mac Address_ 를 [___ARP___](https://github.com/JHTek/TIL/blob/main/Network/ARP.md#arp-packet) 를 통해 알아내어 수신자 _Mac Address_ 로 입력해 보낸다. 
...
이렇게 보면 굉장히 복잡해 번거로워 보이지만 장점이 명확하다.
+ 이 과정은 대부분 한 번 만 이루어진다.
